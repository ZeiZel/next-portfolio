...
export const hiddenPortfolioItemsArray: IPortfolioTabItem[] = [
	{
		id: 7,
	...
	{ id: 8, img: '/img/portfolio-2.png', link: '#', title: 'Лендинг «Гитары»' },
	{ id: 9, img: '/img/portfolio-3.png', link: '#', title: 'Лендинг «LoftHouse»' },
	{ id: 10, img: '/img/portfolio-1.png', link: '#', title: 'Обучающая платформа «Бризли»' },
];
...
export const portfolioItems2: IPortfolioTabItem[] = [
	{
		id: 1,
		img: '/img/portfolio-1.png',
		link: '#',
...
export const portfolioItems3: IPortfolioTabItem[] = [
	{
		id: 1,
		img: '/img/portfolio-1.png',
		link: '#',
